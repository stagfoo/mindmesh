/// Thin wrapper over the `mindmesh/launcher` channel. Marshalling only —
...
class LauncherBridge {
  ...
  static const MethodChannel _channel = MethodChannel('mindmesh/launcher');
  static const EventChannel _packageEvents = EventChannel('mindmesh/packages');
